...
export function WealthCommitments({ commitments }: { commitments: Commitments }) {
  const ctx = useEdit();
  ...
  return (
    <EditableSection
      ...
      className={`py-20 md:py-28 lg:py-32 bg-gradient-to-b from-white to-emerald-50/60 ${
        ...
        >
          {enabled ? (
            ...
            <>
              ...
              <span className="text-emerald-700">מוסתר מהדף — לחצו להצגה</span>
            </>
          )}
        </button>
      )}
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <EditableImage
            ...
            className="w-full h-auto rounded-3xl shadow-card-lift-green ring-1 ring-emerald-100"
