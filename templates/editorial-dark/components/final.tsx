  ...
  return (
    ...
    >
      <div className="max-w-[860px] mx-auto px-6 flex flex-col items-center gap-6">
        <h2 className="m-0 font-medium text-[clamp(34px,5vw,66px)] leading-[1.14] tracking-[-1px] [text-wrap:pretty]">
        ...
        <EditableText
          ...
          as="p"
          multiline
          className="m-0 text-[#a8acb3] text-[clamp(17px,1.8vw,22px)] leading-[1.7] max-w-[56ch]"
        ...
        <EditableText
          ...
          as="div"
          className="text-[15px] text-[#7c828a] mt-2"
      ...
      {/* Footer bar */}
      <div className="max-w-[1200px] mx-auto mt-16 px-6 pt-6 pb-24 border-t border-white/[0.07] flex flex-wrap justify-between gap-3 text-[13.5px] text-[#7c828a]">
        <EditableText
          path="footer.legal"
          as="span"
          multiline
