      ...
      <div className="max-w-[1200px] mx-auto px-6 grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <EditableText
            ...
            as="p"
            multiline
            className="m-0 mb-2.5 text-[#a8acb3] text-base leading-[1.7] max-w-[52ch]"
            placeholder="תיאור"
          />
          <EditableText
        ...
        <div className="flex flex-col gap-3 items-start">
          {bubbles.map((_, i) => {
            ...
            return isAnswer ? (
              <div
                key={i}
                className="bg-[#0052ff] rounded-[18px_18px_4px_18px] px-5 py-3.5 text-[14.5px] font-semibold max-w-[340px] self-end"
              >
              ...
              <div
                key={i}
                className={`bg-[#16181c] border border-white/[0.09] rounded-[18px_18px_18px_4px] px-5 py-3.5 text-[14.5px] text-[#e6e8eb] max-w-[340px] ${
                  i % 2 === 1 ? "mr-8" : ""
                }`}
              >
